...
export const T = {
  ...
  auth: {
    ...
    gateDesc: { en: "Multi-Player matches require an account so we can connect players and keep games fair.", bo: "གྲངས་མང་གི་རྩེད་མོའི་རིགས་ལ་དང་ཐོག་ཐོ་རྒྱག་དགོས། འདི་ནི་རྩེད་མོ་བ་རྣམས་སྦྲེལ་མทུད་བྱ་རྒྱུ་དང་དྲང་བདེན་ཡོང་བའི་ཆེད་དུ་ཡིན།" },
