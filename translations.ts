...
export const T = {
  ...
  lobby: {
    ...
    modeLocal: { en: "Single-Player", bo: "རྩེ་མོ་བ་གཅིག" },
    modeLocalSub: { en: "Play offline", bo: "དྲ་མེད་རྩེད་མོ།" },
    modeMulti: { en: "Multi-Player", bo: "རྩེ་མོ་བ་གྲངས་མང་།" },
  ...
  auth: {
    gateTitle: { en: "Play Multi-Player", bo: "རྩེ་མོ་བ་གྲངས་མང་གི་རྩེད་མོ་ལ་རོལ་ཅིག" },
    gateDesc: { en: "Multi-Player matches require an account so we can connect players and keep games fair.", bo: "རྩེ་མོ་བ་གྲངས་མང་གི་རྩེད་རིགས་ལ་དང་ཐོག་ཐོ་རྒྱག་དགོས། འདི་ནི་རྩེད་མོ་བ་རྣམས་སྦྲེལ་མཐུད་བྱ་རྒྱུ་དང་དྲང་བདེན་ཡོང་བའི་ཆེད་དུ་ཡིན།" },
    gateHint: { en: "You can play Single-Player without signing in.", bo: "གཅིག་གི་རྩེད་མོར་ཐོ་རྒྱག་མི་དགོས་པར་རྩེ་ཆོག" },
    ...
    noAccount: { en: "Don't have an account? Sign Up", bo: "རྩིས་ཐོ་མེད་དམ། ཐོ་ཁོད།" },
    hasAccount: { en: "Already have an account? Login", bo: "རྩིས་ཐོ་ཡོད་དམ། ནང་ལ་འཛུལ།" },
  },
  pro: {
    ...
    feat1: { en: "Unlimited Multi-Player Matches", bo: "ཚོད་འཛིན་མེད་པའི་རྩེ་མོ་བ་གྲངས་མང་གི་རྩེད་འགྲན།" },
