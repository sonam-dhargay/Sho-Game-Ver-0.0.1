...
export const T = {
  ...
  lobby: {
    ...
    modeLocal: { en: "Single-Player", bo: "རྩེད་མོ་བ་ཁེར་རྐྱང།" },
    modeLocalSub: { en: "Play offline", bo: "དྲ་མེད་རྩེད་མོ།" },
    modeMulti: { en: "Multi-Player", bo: "རྩེད་མོ་བ་གྲངས་མང་།" },
  ...
  auth: {
    ...
    gateDesc: { en: "Multi-Player matches require an account so we can connect players and keep games fair.", bo: "རྩེད་མོ་བ་གྲངས་མང་གི་རྩེད་རིགས་ལ་དང་ཐོག་ཐོ་རྒྱག་དགོས། འདི་ནི་རྩེད་མོ་བ་རྣམས་སྦྲེལ་མཐུད་བྱ་རྒྱུ་དང་དྲང་བདེན་ཡོང་བའི་ཆེད་དུ་ཡིན།" },
  ...
  pro: {
    ...
    feat1: { en: "Unlimited Multi-Player Matches", bo: "ཚོད་འཛིན་མེད་པའི་རྩེད་མོ་བ་གྲངས་མང་གི་རྩེད་འགྲན།" },
