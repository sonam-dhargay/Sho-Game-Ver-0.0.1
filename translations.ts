export const T = {
  ...
  lobby: {
    ...
    modeLocalSub: { en: "Play against AI", bo: "མི་བཟོས་རིག་ནུས་དང་མཉམ་དུ་རྩེ།" },
  ...
  auth: {
    ...
    gateDesc: { en: "Multi-Player matches require an account so we can connect players and keep games fair.", bo: "དུ་མའ'ི་རྩེད་རིགས་ལ་དང་ཐོག་ཐོ་རྒྱག་དགོས།འདི་ནི་རྩེད་མོ་བ་རྣམས་སྦྲེལ་མཐུད་བྱ་རྒྱུ་དང་དྲང་བདེན་ཡོང་བའི་ཆེད་དུ་ཡིན།" },
  ...
  pro: {
    ...
    feat1: { en: "Unlimited Multi-Player Matches", bo: "ཚད་འཛིན་མེད་པའི་དུ་མའི་རྩེད་འགྲན།" },
