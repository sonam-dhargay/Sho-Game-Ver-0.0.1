...
export const T = {
  ...
  lobby: {
    ...
    modeMulti: { en: "Multi-Player", bo: "རྩེ་མོ་བ་དུ་མ།" },
  ...
  auth: {
    gateTitle: { en: "Play Multi-Player", bo: "རྩེ་མོ་བ་དུ་མའ'ི་རྩེད་མོ་ལ་རོལ་ཅིག" },
    gateDesc: { en: "Multi-Player matches require an account so we can connect players and keep games fair.", bo: "རྩེ་མོ་བ་དུ་མའ'ི་རྩེད་རིགས་ལ་དང་ཐོག་ཐོ་རྒྱག་དགོས། འདི་ནི་རྩེད་མོ་བ་རྣམས་སྦྲེལ་མཐུད་བྱ་རྒྱུ་དང་དྲང་བདེན་ཡོང་བའི་ཆེད་དུ་ཡིན།" },
  ...
  pro: {
    ...
    feat1: { en: "Unlimited Multi-Player Matches", bo: "ཚོད་འཛིན་མེད་པའི་རྩེ་མོ་བ་དུ་མའི་རྩེད་འགྲན།" },
